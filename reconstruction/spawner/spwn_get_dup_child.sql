delimiter //
drop procedure if exists spwn_get_dup_child //
create procedure spwn_get_dup_child (IN y_task_id int, IN n_task_id int)
...
update tasks set cell_id=0,status=1 where id=n_task_id;
