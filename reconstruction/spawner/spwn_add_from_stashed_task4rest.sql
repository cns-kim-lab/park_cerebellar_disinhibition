delimiter //
drop procedure if exists spwn_add_from_stashed_task4rest //
create procedure spwn_add_from_stashed_task4rest
(IN parent_task_id int, IN stashed_child_task_id int, IN target_cell int)
