% Edited version of '/data/research/iys0819/analysis_interneuron_structure/get_interneuron_axon_skeleton.m'
...
function [branch_path_sub, branch_terminal]= get_interneuron_axon_skeleton(volume, target_segment_omni_id, rt_pnt, p_scale, p_const, close_or_not, largest_cc_only, draw_figure)
...
%     p_const = 20;
    ...
    if draw_figure
    figure; hold on; cellfun(@(x) scatter3(x(:,1),x(:,2),x(:,3), '.'),branch_path_sub); axis equal;
    end
