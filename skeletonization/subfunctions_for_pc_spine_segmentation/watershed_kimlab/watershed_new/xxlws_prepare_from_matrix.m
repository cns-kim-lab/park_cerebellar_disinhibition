function input_size = xxlws_prepare_from_matrix(input, savename, width)
    ...
    for x=1:width:input_size(1)
        ...
        for y=1:width:input_size(2)
            ...
            for z=1:width:input_size(3)
                ...
                partial_data = input(start_point(1):end_point(1), start_point(2):end_point(2), start_point(3):end_point(3), 1:3);
